...
char* generate_readme_template(const char *project_name) {
  ...
  snprintf(template, 1024,
           "# %s\n\n"
           "A C project created with **sbor** - the C project manager.\n\n"
           "## Building\n\n"
           "```
...
"## Managing Dependencies\n\n"
  ...
  "sbor add string\n"
    ...
    "- `src/include.h` - Managed header includes\n"
    "- `CMakeLists.txt` - Build configuration\n"
    "- `sbor.conf` - Project configuration\n",
